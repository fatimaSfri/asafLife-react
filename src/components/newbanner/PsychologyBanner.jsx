...
export default function PsychologyBanner(props) {
      ...
      <div className=" md:bg-bg-psychology max-md:bg-bg-sm-psychology back_medium_01  bg-[length:100%_100%] bg-no-repeat shadow-md h-[750px]  w-full  flex justify-center max-md:flex-col items-center">
          ...
          <div className=" md:w-3/12 md:h-4/5  max-md:w-10/12 max-md:h-1/6  flex items-center justify-center ">
           <img src="./img/Animation/psychology/03-Play.png" alt=""  className="max-md:h-3/6 md:w-3/12 xl:w-[20%]  md:hover:w-[23%] transition-width duration-300 ease-in-in max-md:hover:h-[60%]  z-30 cursor-pointer"  onClick={props.videoShowHandle} />
          ...
          {/* object */}
          <div className=" md:w-4/12 md:h-4/5  xl:w-[28%] max-md:w-full max-md:h-3/6 jump-to-right max-md:p-8 flex items-center max-lg:w-8/12 justify-center md:mt-20">
