...
export default function MobileBanner(props) {
     ...
     <>
       {/* for max-md */}
       <div className= " max-md:bg-bg-sm-mobile md:bg-bg-mobile back_medium_01  bg-[length:100%_100%] bg-no-repeat shadow-md h-[750px]  w-full  flex justify-center max-md:flex-col items-center ">
