...
export default function LegalBanner(props) {
      ...
      const [ image , setImage ] =useState([
          './src/assets/img/Animation/treatment/02-ob.png', 
          './src/assets/img/Animation/treatment/02-Textbutton.png',
       ])  
     ...
     <div className= " xl:max-w-[550px] max-xl:max-w-[400px] max-sm:min-w-[250px] jump-to-left flex md:flex-col md:justify-center items-center md:mt-20 z-20">
      ...
      <img src="./src/assets/img/Animation/treatment/02-Arrow.svg" alt="" className="max-md:hidden mt-5 -mr-20 image w-4/12 "></img>
     </div>
    
     {/* play */}
     <div className=" md:w-3/12 md:h-4/5  max-md:w-10/12 max-md:h-1/6  flex items-center justify-center ">
      <img src="./src/assets/img/Animation/treatment/02-Play.png" alt=""  className="
