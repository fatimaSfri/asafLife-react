...
export default function LifeBanner(props) {
     ...
     <>
       {/* for max-md */}
       <div className=  {`max-md:bg-bg-sm-life md:bg-bg-life back_medium_01  bg-[length:100%_100%] bg-no-repeat shadow-md h-[750px] w-full flex justify-center max-md:flex-col items-center  
        ${props.gap}`}>
     ...
     {/* object */}
     <div className= {`md:h-4/5 xl:w-[600px] sm:min-w-[350px] max-sm:w-full max-md:h-5/6 -mb-[4.5rem] jump-to-right max-md:p-8 flex items-center 
