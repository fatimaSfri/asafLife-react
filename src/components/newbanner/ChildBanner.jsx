...
export default function PsychologyBanner(props) {
      ...
      const [ image , setImage ] =useState([
          './src/assets/img/Animation/children/03-ob.png', 
          './src/assets/img/Animation/children/03-Textbutton.png',
       ])  
      ...
      <div className=" md:bg-bg-children max-md:bg-bg-sm-children back_medium_01 bg-[length:100%_100%] bg-no-repeat shadow-md h-[750px]  w-full  flex justify-center max-md:flex-col-reverse items-center  overflow-hidden">
         ...
         <div className=" lg:max-w-[500px] max-sm:w-full max-md:h-3/6 xl:-mb-[16rem] max-xl:-mb-[16rem] max-lg:-mb-[26rem] max-md:-mb-[8rem] jump-to-left max-md:p-8 flex items-center justify-center ">
          ...
          {/* play */}
           ...
           <img src="./src/assets/img/Animation/children/03-Play.png" alt=""  className="xl:w-[90px]  max-xl:w-[70px] xl:hover:w-[100px] max-xl:hover:w-[80px] transition-width duration-300 ease-in-in z-30 cursor-pointer "  onClick={props.videoShowHandle} />
           <img src="./src/assets/img/Animation/PlayText.svg" alt=""  className=" absolute route xl:w-[140px] max-xl:w-[100px] cursor-pointer " />
           <img src='./src/assets/img/Animation/car/mouse.png' className='absolute z-30 lg:w-[30px] lg:h-[40px] max-lg:w-[20px] max-lg:h-[25px] movement md:-mb-[90px] md:ml-[70px] max-md:ml-[50px] max-md:-mb-[70px]' ></img>
          </div>
           ...
           <img src="./src/assets/img/Animation/children/03-Arrow.svg" alt="" className="max-md:hidden mt-5 -ml-20 image-reverse  w-4/12" ></img>
          </div>
