...
//      classNameText:' text-[#ffffff] bg-[#014e4c] ' , sloganClass:"text-[#005051]" , rotate:'rotate'  },
...
//         ${ imgSecond ? 'rotate' : ''}`}
//          >
//          <div className="flex flex-col h-full w-full justify-end items-end slide " 
//           >
//          {!sliderImages[newIndex].videoShow &&
//          <div className="flex h-full w-full justify-end items-end max-md:flex-col max-md:justify-center max-md:items-center " >
//          <div className="w-1/2 h-5/6 max-md:w-10/12 text-center flex flex-col items-center justify-center max-md:text-[20px] text-white gap-y-3" >
//          <p className={`text-[60px] max-lg:text-[50px] max-sm:text-[30px] font-KalamehBold ${sliderImages[newIndex].sloganClass}`} >
//           {sliderImages[newIndex].title}
//          </p>
//          <p className= {`text-[45px] max-lg:text-[35px] max-sm:text-[20px] font-KalamehRegular ${sliderImages[newIndex].sloganClass} `}  >
//         {sliderImages[newIndex].text}
//          </p> 
//           <a  className="w-6/12 " ><button className={`lg:w-9/12 max-lg:w-11/12 mx-auto text-[26px] max-md:text-[18px] shadow-lg flex justify-center items-center h-10  lg:mt-3 pb-[12px] rounded-lg  mix-hard-light text-shadow-custom  pt-3  ${sliderImages[newIndex].classText}`}
...
//        <img src={sliderImages[newIndex].frontObject1}  className="object-contain absolute  mix-blend-soft-light object-fit  max-md:w-10/12  max-md:h-1/2 max-md:mx-auto md:w-1/2 h-5/6  max-md:mt-64">
//        </img>}
//          </div>
//       }
//              { sliderImages[newIndex].videoShow &&
//                <div className="w-full h-full flex items-center justify-center"  >
//                   <video src={sliderImages[newIndex].video} className="opacity-80" autoPlay
//                   muted></video>
//                </div>
//              }
//             <div className="w-full h-20 flex items-end justify-center gap-4 mb-2">
//            { sliderImages.map((item,index) =>(
//              <span className={`w-4 h-4 bg-white rounded-full block transition-all 
