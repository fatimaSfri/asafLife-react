    ...
    <div className="w-full h-auto flex max-xl:flex-col-reverse relative overflow-hidden mb-24">
      ...
      <div className="w-1/2 h-[400px] flex max-xl:h-[30vh] max-md:w-9/12 max-lg:w-7/12 max-xl:w-5/12 mx-auto" >
        <div className="w-9/12 h-full max-xl:w-full" >
          ...
          شرکــت کــارگذاری آینده ســازان آسایــش فردا با  سابقــه 30 ساله مدیــران خود در عرضه تجــارت و بیمــه وایجــاد باشگاه مشتریــان. شرکــت کــارگذاری آینده ســازان آسایش فـردا با  سابقـه 30 سالــه مدیـران خود در عرضــه تجــارت و بیمـــه وایجــاد باشگــاه مشــتریان.    
          </p>
        </div>
