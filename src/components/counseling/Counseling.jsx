  ...
  const cards = [
    {
      ...
      duration: "۶۰ دقیقه",
      color:"#55c7e0",
      image: "./img/counseling/img-psy.webp",
    ...
    },
    {
      ...
      duration: "۶۰ دقیقه",
      color: "#115052",
      image: "./img/counseling/img-legal.webp",
    ...
    },
    {
      ...
      description: " شرکت آینده سازان آسایش فردا با سابقه 30 ساله مدیران خود در عرضه تجارت و بیمه و ایجاد باشگاه مشتریان  ",
       duration: "۶۰ دقیقه",
       color:"#6827b5",
      image: "./img/counseling/img-investment.webp",
    ...
    <div className="w-full h-auto flex max-xl:flex-col-reverse relative overflow-hidden mb-24" data-aos="fade-up" data-aos-duration="2000">
        ...
        <div className=" flex  w-full gap-4  " >
          ...
          {cards.map((card, index) => (
            ...
            <div key={index}
             ...
             <div className="bg-[rgba(250,250,250,0.78)] shadow-lg rounded-lg w-11/12 overflow-hidden absolute mb-28 group-hover:h-80 group-hover:mb-80 group-hover:justify-around transition-all duration-300 ease-out flex flex-col ">
                <div className="p-1 transition-all duration-900 h-16  group-hover:mb-32">
                ...
                <p className="text-gray-600 text-[12px]">{card.subtitle}</p></div>
                <div className='flex gap-1'>
                <img src={card.iconUser} alt=""  className='w-4 h-4'/>
                <p className="text-gray-600 text-[12px]"> {card.duration}</p></div>
                </div>
                <p className='text-[12px] mt-5'>{card.description}</p>
               <div className="opacity-0 group-hover:opacity-100  group-hover:mt-4 transition-opacity duration-300 ">
               <Link to={card.link}> <button className = 'mouse-pointer text-white font-bold py-1 px-4 rounded-xl transition-colors duration-300' 
      ...
      <div className="w-1/2 flex  max-md:w-9/12 max-lg:w-7/12 max-xl:w-5/12 mx-auto" >
        ...
        <div className=" w-3/12 max-sm:w-1/12 h-full flex-col max-xl:justify-between items-center mx-auto p-5 ">
            <img src="./img/counseling/01-ob.webp" alt="" className='sm:w-14 sm:h-14 max-sm:w-10 max-sm:h-10 suspended max-md:absolute cu'/>
          <div></div>
          <div></div>
        </div>
      </div>
