...
export default function Informathion() {
  ...
  return (
    <div className="w-full flex justify-center items-center max-lg:h-screen lg:h-[600px] slide max-lg:flex-col-reverse my-32 py-8 bg-gray-100" >
      {/* Information Section */}
      ...
      <div className="lg:w-1/2 max-lg:w-full h-[50vh] flex items-center justify-center relative lg:ml-20 ">
        <div className="sm:w-[500px] max-sm:w-11/12 h-full max-md:h-5/6 flex items-end absolute ">
          ...
          <img src="./img/info/family-photo.png" alt="" className="md:w-11/12 max-md:w-10/12 absolute self-center mr-2 " />
        </div>
      </div>
    </div>
  );
