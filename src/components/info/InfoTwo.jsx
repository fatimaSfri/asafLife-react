...
export default function Informathion() {
  ...
  return (
    ...
    <div className="w-full flex justify-center items-center max-lg:h-screen lg:h-[600px] max-lg:flex-col-reverse my-32 py-8 bg-elderly" data-aos="fade-right" data-aos-duration="2000">
      {/* Information Section */}
     ...
     <div className='lg:w-1/2 max-lg:w-full h-[450px] flex items-center justify-center relative max-sm:overflow-hidden '>
