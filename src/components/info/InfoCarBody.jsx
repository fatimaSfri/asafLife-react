...
export default function InfoCarBody() {
  return (
        <div className="w-full flex justify-center items-center max-lg:h-screen lg:h-[600px] max-lg:flex-col-reverse my-32 py-8 bg-carBody" data-aos="fade-right" data-aos-duration="2000">
          {/* Information Section */}
