...
//     const [inCheckedButton, setIsCheckedButton] = useState(false);
...
//                             checked={isChecked && inCheckedButton}
...
//                     <label className={`flex items-center cursor-pointer ${isScrollable ? 'text-[#213063]' : 'text-gray-400 cursor-not-allowed'}`}>
//                         <button
//                             className={`ml-4 px-4 py-2 rounded-lg ${inCheckedButton && isScrollable ? 'bg-[#55c7e0] text-white hidden' : 'bg-gray-200 text-gray-600 '}`}
//                             onClick={() => setIsCheckedButton(prev => !prev)}

//                             onChange={handleCheckboxChange}
//                             checked={inCheckedButton}
//                             disabled={!isScrollable}
//                         >
//                             قوانین را خوانده‌ام و موافقم
//                             {inCheckedButton && <span className="w-3 h-3 bg-[#55c7e0] rounded-full"></span>}
//                         </button>
//                     </label>
                    ...
                    <div className="flex items-center gap-6 py-4 mt-10">
                        <button
                            className={`ml-4 px-4 py-2 rounded-lg transition-all duration-300 ${
                                isScrollable
                                    ? 'bg-[#55c7e0] text-white cursor-pointer'
