...
export default function Menu() {
  ...
  return (
    <div className='h-screen w-full bg-[rgba(0,0,0,0.8)] fixed z-30 ' dir='ltr'> 
    ...
    <div className='flex justify-center items-end  h-[7%] '>
       <img src="/img/menu/ASAFLogo.svg" className="w-[100px]"></img>  
      ...
      <div className='w-full  h-full flex flex-col '>
       ...
       <div className="bg-white w-full h-14 mt-2 rounded-xl flex justify-end items-center">
         <p className="text-[20px]"> خانه</p>
         <img src="./img/menu/home.png" alt="" className="w-6 h-6 mx-4" />
         <img src="./img/menu/angle.svg" alt="" className="w-6 h-6 mx-4" />
       </div>
         {/* ************ */}
         <div className="bg-white w-full h-14 mt-2 rounded-xl flex justify-end items-center">
         <p className="text-[20px]"> سرویس ها</p>
         <img src="./img/menu/service-tools.png" alt="" className="w-6 h-6 mx-4" />
         <img src="./img/menu/angle.svg" alt="" className="w-6 h-6 mx-4" />
       </div>
         {/* ************ */}
         <div className="bg-white w-full h-14 mt-2 rounded-xl flex justify-end items-center">
         <p className="text-[20px]"> درباره ما</p>
         <img src="./img/menu/mentoring.png" alt="" className="w-6 h-6 mx-4" />
         <img src="./img/menu/angle.svg" alt="" className="w-6 h-6 mx-4" />
       </div>
         {/* ************ */}
         <div className="bg-white w-full h-14 mt-2 rounded-xl flex justify-end items-center">
         <p className="text-[20px]"> وبلاگ</p>
         <img src="./img/menu/web-design.png" alt="" className="w-6 h-6 mx-4" />
         <img src="./img/menu/angle.svg" alt="" className="w-6 h-6 mx-4" />
       </div>
         {/* ************ */}
         <div className="bg-white w-full h-14 mt-2 rounded-xl flex justify-end items-center">
         <p className="text-[20px]"> پشتیبانی</p>
         <img src="./img/menu/helpdesk.png" alt="" className="w-6 h-6 mx-4" />
         <img src="./img/menu/angle.svg" alt="" className="w-6 h-6 mx-4" />
       </div>
         {/* ************ */}
         <div className="bg-white w-full h-14 mt-2 rounded-xl flex justify-end items-center">
         <p className="text-[20px]"> سامانه</p>
    ...
    <button className="w-9/12 bg-white text-[#55c7e0] h-9 border-red-950 rounded-xl">ورود / ثبت نام</button>
    <div className='h-[2px] w-9/12 bg-gray-400 '></div>
    <div className="w-9/12  h-10 -mt-4 flex flex-row-reverse  justify-evenly "> 
    <div className="flex items-center "> 
    <p className="text-gray-500 text-[16px] pr-2">09121887644</p>
    <img src="./img/menu/phone.png" alt="" className="w-5 h-5"/>
   </div>
   <div className="flex items-center "> 
    <p className="text-gray-500 text-[16px] pr-2">021-91098951</p>
